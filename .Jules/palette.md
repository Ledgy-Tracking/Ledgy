...
## 2025-02-23 - Sidebars and Collapsible Rails
**Learning:** Sidebars and collapsible inspector panels typically lack accessibility context. Screen reader users need to know if a panel is expanded or collapsed, and which button controls it.
**Action:** Always add `aria-expanded` and `aria-controls` to the toggle buttons, and an `id` to the panel itself.

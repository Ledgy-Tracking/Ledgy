...
export const EmptyCanvasGuide: React.FC<EmptyCanvasGuideProps> = ({ onAddFirstNode }) => {
    return (
        <div className="absolute inset-0 flex items-center justify-center pointer-events-auto z-10">
            <div className="bg-white dark:bg-zinc-950/90 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-8 max-w-md text-center shadow-2xl backdrop-blur-sm">
                ...
                {onAddFirstNode && (
                    <Button
                        ...
                        size="lg"
                        className="w-full bg-emerald-600 hover:bg-emerald-500 text-zinc-900 dark:text-white font-bold mb-6 group transition-all"
                    >

...
export const calculateBoundingBox = (nodes: Node[]): ContainerBounds => {
    ...
    // ⚡ Bolt: Replace multiple .map() arrays and spread operations with a single pass loop
    // Prevents redundant iterations, intermediate array allocations, and 'Maximum call stack size' via spreading

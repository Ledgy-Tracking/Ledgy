...
export const calculateBoundingBox = (nodes: Node[]): ContainerBounds => {
    ...
    // ⚡ Bolt: Single-pass for loop avoids spreading large arrays into Math.max/min
    // which prevents Maximum Call Stack limits errors, and removes intermediate allocations.

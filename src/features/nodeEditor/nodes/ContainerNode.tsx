    ...
    return (
        ...
        >
            ...
            >
                ...
                <div
                    ref={headerRef}
                    className="container-header flex items-center justify-between px-3 py-2 bg-zinc-100 dark:bg-zinc-800 border-b border-zinc-300 dark:border-zinc-700 cursor-pointer"

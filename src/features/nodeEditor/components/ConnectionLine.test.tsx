...
const createMockProps = (
    overrides: Partial<ConnectionLineComponentProps & { connectionStatus?: 'valid' | 'invalid' | 'default' | 'snapped' | null }> = {}
): ConnectionLineComponentProps & { connectionStatus?: 'valid' | 'invalid' | 'default' | 'snapped' | null } => ({
    fromX: 100,
    fromY: 100,
    toX: 300,
    toY: 200,

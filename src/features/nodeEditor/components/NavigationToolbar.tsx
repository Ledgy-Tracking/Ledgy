...
export const NavigationToolbar: React.FC = () => {
    ...
    // ⚡ Bolt: Subscribe specifically to nodes.length instead of the entire nodes array
    // This prevents the toolbar from re-rendering whenever a node's internal state (like position or selection) changes

        ...
        <>
            ...
            {showTooltip && (
                <g>
                    ...
                    >
                        <div className="bg-gray-50 dark:bg-zinc-900/95 border border-emerald-500/50 rounded px-2 py-1.5 text-[10px] text-zinc-800 dark:text-zinc-200 shadow-xl z-50 backdrop-blur-sm">

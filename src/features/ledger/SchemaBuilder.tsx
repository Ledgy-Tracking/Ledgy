...
export const SchemaBuilder: React.FC<SchemaBuilderProps> = ({ onClose }) => {
    ...
    const handleSave = async (e: React.FormEvent) => {
        ...
        try {
            setError(null);
            await createSchema(activeProfileId, schemaName.trim(), fields);
            onClose();
        } catch (err: any) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-zinc-900/50 dark:bg-black/70 backdrop-blur-sm p-4">
            ...
            >
                ...
                <div className="flex justify-end space-x-3">
                    ...
                    <button
                        type="submit"
                        disabled={isLoading || !schemaName.trim() || fields.length === 0}

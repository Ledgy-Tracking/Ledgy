...
export const ProfileCreationPage: React.FC = () => {
    ...
    const containerClasses = cn(
        "min-h-screen bg-white dark:bg-zinc-950 text-zinc-900 dark:text-white flex flex-col items-center justify-center p-4 selection:bg-emerald-500/30",
        {
    ...
    return (
        <div className={containerClasses}>
            ...
            {/* Content Container */}
            <Card className="relative z-10 w-full max-w-2xl bg-gray-50 dark:bg-zinc-900/50 backdrop-blur-xl border border-white/5 rounded-3xl p-8 sm:p-12 shadow-2xl flex flex-col animate-in fade-in slide-in-from-bottom-8 duration-700 ease-out fill-mode-both">

                {/* Header */}
                <div className="flex flex-col items-center justify-center text-center space-y-4 mb-10">
                    <Card className="h-16 w-16 bg-emerald-500/20 text-emerald-400 rounded-2xl flex items-center justify-center mb-2 shadow-inner ring-1 ring-emerald-500/30">

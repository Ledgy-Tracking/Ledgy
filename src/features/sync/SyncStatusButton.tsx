    ...
    return (
        ...
        >
            ...
            <div
                ...
                className="p-1 rounded hover:bg-zinc-200 dark:hover:bg-zinc-600 text-zinc-400 hover:text-emerald-500 transition-all focus:outline-none focus:ring-2 focus:ring-emerald-500"
